...
#define     GPIOA_OTYPER        *(( volatile uint16_t* )(0x40020004))
#define     GPIOA_OSPEEDER      *(( volatile uint32_t* )(0x40020008))
#define     GPIOA_PUPDR         *(( volatile uint32_t* )(0x4002000C))
#define     GPIOA_IDR           *(( volatile uint16_t* )(0x40020010))
#define     GPIOA_ODR           *(( volatile uint16_t* )(0x40020014))
#define     GPIOA_BSRR          *(( volatile uint32_t* )(0x40020018))
#define     GPIOA_LCKR          *(( volatile uint16_t* )(0x4002001C))
...
#define     GPIOB_OTYPER        *(( volatile uint16_t* )(0x40020404))
#define     GPIOB_OSPEEDER      *(( volatile uint32_t* )(0x40020408))
#define     GPIOB_PUPDR         *(( volatile uint32_t* )(0x4002040C))
#define     GPIOB_IDR           *(( volatile uint16_t* )(0x40020410))
#define     GPIOB_ODR           *(( volatile uint16_t* )(0x40020414))
#define     GPIOB_BSRR          *(( volatile uint32_t* )(0x40020418))
#define     GPIOB_LCKR          *(( volatile uint16_t* )(0x4002041C))
...
#define     GPIOC_OTYPER        *(( volatile uint16_t* )(0x40020804))
#define     GPIOC_OSPEEDER      *(( volatile uint32_t* )(0x40020808))
#define     GPIOC_PUPDR         *(( volatile uint32_t* )(0x4002080C))
#define     GPIOC_IDR           *(( volatile uint16_t* )(0x40020810))
#define     GPIOC_ODR           *(( volatile uint16_t* )(0x40020814))
#define     GPIOC_BSRR          *(( volatile uint32_t* )(0x40020818))
#define     GPIOC_LCKR          *(( volatile uint16_t* )(0x4002081C))
